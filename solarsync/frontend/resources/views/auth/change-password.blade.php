...
<div class="w-full max-w-sm">
    ...
    <div class="text-center mb-8">
        ...
        <h1 class="text-2xl font-bold text-gray-900">Welcome to SolarSync</h1>
        <p class="text-sm text-gray-500 mt-1">Set your username and password to get started</p>
    </div>
        ...
        <form method="POST" action="{{ route('auth.change-password.update') }}" class="space-y-5">
            ...
            <div>
                ...
                <input
                    ...
                    id="username"
                    name="username"
                    value="{{ old('username', auth()->user()->name !== 'admin' ? auth()->user()->name : '') }}"
                    required
                    autofocus
