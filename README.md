...
5. Auto-generate all internal secrets (API key, MQTT credentials)
...
**Everything else is handled automatically or through the UI:**

- `INTERNAL_API_KEY` — generated by the install script (`openssl rand -hex 32`)
- `APP_KEY` — generated by the install script (`php artisan key:generate`)
